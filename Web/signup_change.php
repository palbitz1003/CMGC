...
echo '<ul>' . PHP_EOL;
echo '<li><a href="http://' . $web_site . '/' . $script_folder_href . 'signup_remove_players.php?tournament=' . $tournamentKey . '&signup=' . $submitKey . '">Remove Players</a>';
echo ' - Remove players from your group.  This will trigger a refund if you have paid the tournament fees.</li>' . PHP_EOL;
echo '<li><a href="http://' . $web_site . '/' . $script_folder_href . 'signup_change_players.php?tournament=' . $tournamentKey . '&signup=' . $submitKey . '">Change Players</a>';
