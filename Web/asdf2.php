...
if (isset ( $_POST ['RequestedTimeRange'] )) {
    if($_POST ['RequestedTimeRange'] === "Last 1 Year"){
        ...
        // unexpected choice
        echo 'unexpected choice ' . $_POST ['RequestedTimeRange'] . '<br>';
    }
} else {
...
echo '<input type="text" name="ghin" maxlength="10" size="10" value="' . $ghin . '"><br>' . PHP_EOL;
echo '<input type="submit" value="Refresh"> <br> <br>' . PHP_EOL;
echo '</form>' . PHP_EOL;
